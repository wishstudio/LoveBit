...
const uint hi[8] = {0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19};
...
#define RRotate(x, n) (((x) >> n) | (x << (32 - n)))
#define RShift(x, n) ((x) >> n)

void SHA256::update(uint w[])
{
    for (int i = 16; i < 64; i++)
    {
